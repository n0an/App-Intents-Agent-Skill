...
- Prefer `OpenIntent` for "take me to this thing" actions, and `AppIntent & ProvidesDialog & ShowsSnippetView` for "just tell me/show me a summary" actions. They solve different user needs.
